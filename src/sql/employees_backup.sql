CREATE TABLE `employees_backup` (
  ...
  `last_name` varchar(35) CHARACTER SET latin1 COLLATE latin1_german1_ci NOT NULL,
  `first_name` varchar(35) CHARACTER SET latin1 COLLATE latin1_german1_ci NOT NULL,
  `profession` set('Apotheker','PI','PTA','PKA','Praktikant','Ernährungsberater','Kosmetiker','Zugehfrau') CHARACTER SET latin1 COLLATE latin1_german1_ci NOT NULL,
