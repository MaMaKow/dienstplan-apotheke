...
if (isset($_POST) && !empty($_POST)) {
    ...
    $location = PDR_HTTP_SERVER_APPLICATION_PATH . 'src/php/pages/collaborative-vacation-year.php' . "?year=$year&month_number=$month_number&employee_key=$employee_key";
...
$session->exit_on_missing_privilege('request_own_absence'); //TODO: Handle non existing rights without exit!
