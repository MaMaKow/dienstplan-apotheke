...
$Principle_roster = \principle_roster::read_current_principle_roster_from_database($branch_id, clone $date_object, clone $date_object, array(principle_roster::OPTION_SHOW_FUTURE_EMPLOYEES));
