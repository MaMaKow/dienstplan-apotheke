 ...
 */
/**
 * This class provides the option to assign a specific shift in a rotation.
 *
 ...
 * The function examine_attendance::check_for_attendant_absentees() will however create a warning/error.
 *
