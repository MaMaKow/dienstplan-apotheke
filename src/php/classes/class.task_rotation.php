...
abstract class task_rotation {
    ...
    public static function task_handle_user_input() {
        $task = user_input::get_variable_from_any_input('task_rotation_task', FILTER_SANITIZE_SPECIAL_CHARS);
        $date_sql = user_input::get_variable_from_any_input('task_rotation_date', FILTER_SANITIZE_SPECIAL_CHARS);
