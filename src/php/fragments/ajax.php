...
function form_input_user_page() {
    $receive_emails_opt_in = filter_input(INPUT_POST, 'receive_emails_opt_in', FILTER_SANITIZE_SPECIAL_CHARS);
...
if (filter_has_var(INPUT_POST, 'form')) {
    if ('user_form' === filter_input(INPUT_POST, 'form', FILTER_SANITIZE_SPECIAL_CHARS)) {
