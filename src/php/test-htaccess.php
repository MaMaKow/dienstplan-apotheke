...
function secret_folder_is_secure($folder = "/tmp/") {
    ...
    if (200 == $response_code) {
        ...
        $error_message = "Error! The result could not be interpreted for the directory $filename. The server returned: '$response'. Please make sure that the directory is not accessible by the public!";
        return $error_message;
    }
}
