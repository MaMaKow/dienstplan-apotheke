...
You can navigate to:
\begin{itemize}
\item Roster week table view \includegraphics[height=2em]{../img/md_view_week}
\item Roster daily view \includegraphics[height=2em]{../img/md_today-24px}
...
\item Absence \includegraphics[height=2em]{../img/md_card_travel-24px}
\end{itemize}
