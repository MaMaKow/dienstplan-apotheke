...
The roster week table view shows the roster of a chosen week and branch (Figure~\ref{img_roster_week_table_view}). If employees of the branch are working in an other branch, then those are shown below.
