...
The date can be chosen by direct input. It can also be shifted by one week backwards or forwards by pressing Ctrl + Shift + $\rightarrow$ or Ctrl + Shift + $\leftarrow$ respectively.
