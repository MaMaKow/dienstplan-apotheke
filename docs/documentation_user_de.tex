...
\begin{itemize}
\item Dienstplan Wochenansicht \includegraphics[height=2em]{../img/md_view_week}
...
Einzelne Zeilen können gelöscht \menu{\includegraphics[height=.7em]{../img/md_delete_forever}} oder nachträglich bearbeitet \menu{\includegraphics[height=.7em]{../img/md_edit}} werden. Eine Bearbeitung kann wahlweise gespeichert \menu{\includegraphics[height=.7em]{../img/md_save}} oder abgebrochen \changemenucolortheme{menus}{gray}\menu{\includegraphics[height=.7em]{../img/md_delete_forever}}werden.
