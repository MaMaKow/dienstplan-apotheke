...
$output = array();
echo "exec: Holen\n";
echo exec("bash /var/www/nextcloud-data/Martin/files/Dokumente/Freizeit/Programmierung/git/dienstplan-apotheke/tests/test_application_refresh_from_nextcloud.sh", $output);
echo "\n";
var_export($output);
echo "</pre>\n";
