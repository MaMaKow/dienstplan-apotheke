...
random_live_user_name=$(tr -dc a-z </dev/urandom | head -c 32; echo)
random_live_user_passphrase=$(tr -dc A-Za-z0-9 </dev/urandom | head -c 32; echo)
random_live_root_passphrase=$(tr -dc A-Za-z0-9 </dev/urandom | head -c 32; echo)
