...
echo "<img src=dienstplan_".$datum.".png?".filemtime('images/dienstplan_'.$datum.'.png')." style=width:90%;><br>"; //Um das Bild immer neu zu laden, wenn es verändert wurde müssen wir das Cachen verhindern.
echo "<img src=histogramm_".$datum.".png?".filemtime('images/dienstplan_'.$datum.'.png')." style=width:90%;></td>";
